...
import { DataSourceOptions, SecureJsonData } from '../src/types';
...
test('"Save & test" should be successful when configuration is valid', async ({
  ...
  const ds = await readProvisionedDataSource<DataSourceOptions, SecureJsonData>({ fileName: 'datasources.yml' });
